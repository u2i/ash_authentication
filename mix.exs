  ...
  defp docs do
    [
      ...
      extras: [
        ...
        {"documentation/dsls/DSL-AshAuthentication.AddOn.AuditLog.md",
         search_data: Spark.Docs.search_data_for(AshAuthentication.AddOn.AuditLog)},
        ...
        {"documentation/dsls/DSL-AshAuthentication.Strategy.Microsoft.md",
         search_data: Spark.Docs.search_data_for(AshAuthentication.Strategy.Microsoft)},
        ...
        {"documentation/dsls/DSL-AshAuthentication.Strategy.Okta.md",
         search_data: Spark.Docs.search_data_for(AshAuthentication.Strategy.Okta)},
        ...
        {"documentation/dsls/DSL-AshAuthentication.Strategy.RememberMe.md",
         search_data: Spark.Docs.search_data_for(AshAuthentication.Strategy.RememberMe)},
        ...
        {"documentation/tutorials/audit-log.md", title: "Audit Log"},
        {"documentation/tutorials/auth0.md", title: "Auth0"},
        {"documentation/tutorials/confirmation.md", title: "Confirmation"},
        {"documentation/tutorials/dynamic-oidc.md", title: "Dynamic OIDC"},
        {"documentation/tutorials/get-started.md", title: "Get Started"},
        {"documentation/tutorials/github.md", title: "GitHub"},
        {"documentation/tutorials/google.md", title: "Google"},
        {"documentation/tutorials/magic-links.md", title: "Magic Link"},
        {"documentation/tutorials/microsoft.md", title: "Microsoft"},
        {"documentation/tutorials/okta.md", title: "Okta"},
        {"documentation/tutorials/otp.md", title: "One Time Password"},
        {"documentation/tutorials/password.md", title: "Password"},
      ...
      groups_for_modules: [
        ...
        Introspection: [
          ...
          AshAuthentication.AuditLogResource.Info,
